Jira Server 5.x Plug-In for SpiraTeam(R)
=========== ======= === ============
...
data between SpiraTest(R), SpiraPlan(R) or SpiraTeam(R) and a variety of other systems, including Atlassian Jira Server 5.x or later.

(C) Copyright 2006-2019 Inflectra Corporation
